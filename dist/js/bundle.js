...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"elements\", function() { return elements; });\nvar elements = {\n  list: document.querySelector('#links-list'),\n  newImg: document.querySelector('#link-img'),\n  newTitle: document.querySelector('#link-title'),\n  newDesc: document.querySelector('#link-desc'),\n  newLinkBtn: document.querySelector('#link-new')\n};\n\n//# sourceURL=webpack:///./src/js/views/base.js?");
